...
public:
	 ...
	 */
	//声明在Vector2.h
	explicit FORCEINLINE RBVector3( const RBVector2 v, f32 az);	
	 ...
	 */
	//explicit RBVector3(const FLinearColor& InColor);
	 ...
	 */
	//explicit RBVector3( FIntPoint A );
	...
	*/
	...
	{
		const f32 t = a|b;
		return (RBMath::abs(t-1.f) <= VECTORS_ARE_PARALLEL);
	}
